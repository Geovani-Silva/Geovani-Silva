...
| 🛒 **MarketPlace Empreenda Fácil** | Plataforma completa para vendas e oportunidades voltada a empreendedores locais. | [Ver projeto](https://meunegocio.42web.io/empreendafacil/loja) |
| 🌾 **Agro Fácil** | Sistema de gestão agrícola integrada e controle de produção. | [Explorar](https://agrofacil.42web.io/login.php) |
